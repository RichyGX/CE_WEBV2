...
<div className="card">
    <div className="card-body">
        <div className="row">
            <div className="col">
                <h4 className="card-title">Tipo de solicitud</h4>
            </div>
            <div className="col">
            <button type="button" class="btn btn-light">
  Permisos restantes <span style={{borderRadius: "50%", padding: 10, fontSize: 20, marginLeft: 20}}  class="badge bg-secondary">3</span>
</button>
            </div>
        </div>
        <div className="row mt-4">
            <div className="col ">
            <div class="card text-center " style={{backgroundColor: "#D3D3FF"}}>
            <div class="card-body">
  ...
  <p>Reunion</p>
        ...
        <tbody>
          <tr>
            ...
            <td>
            <Button variant="outline-success" size="sm" className="d-block mx-auto">Ver permiso</Button>
            </td>
          </tr>
          <tr>
            <td>30/MARZO/2025</td>
        ...
        <div className="row mt-5">
            <div className="col">
            <h4><b>Historial de permisos</b></h4>
            <Table striped bordered hover responsive className='PagosPendientes'>
        <thead>
          <tr>
            <th>Fecha y hora</th>
