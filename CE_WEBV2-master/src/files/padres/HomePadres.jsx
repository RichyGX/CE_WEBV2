            ...
            <div class="card-body">
              ...
              <div className="card mt-2">
                <div className="card-body">
                  ...
                  to="/penel"
                  type="Button"
                    className="btn-pagar btn btn-outline-secondary"
                  >
                    Ir a pagar
                  </Link>
                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                      <div className="row">
                        <div className="col">
                          <span style={{ fontSize: 36, color: "#339901" }}>
                            {" "}
                      ...
                      <div className="row">
                        <div className="col">
                          <span style={{ fontSize: 36, color: "#000000" }}>
                            Miercoles{" "}
                          </span>
                          <span style={{ fontSize: 96, color: "#FFCC01" }}>
                            19
                          </span>
                          <span style={{ fontSize: 36, color: "#000000" }}>
                            {" "}
                          ...
                          <span style={{ fontSize: 36, color: "#9747FF" }}>
                            marzo
                          </span>
                        </div>
                      </div>
